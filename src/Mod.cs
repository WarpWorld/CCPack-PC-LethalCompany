        ...
        try
        {
            ...
            switch (values[0])
            {
                ...
                case "landmine":
                {
                    ...
                    GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(prefab, pos, Quaternion.Euler(-90, 0, 0), Mod.currentStart.propsContainer);
                ...
                case "giver":
                {
                    ...
                    Terminal terminal = UnityEngine.Object.FindObjectOfType<Terminal>();
                    GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(StartOfRound.Instance.allItemsList.itemsList[give].spawnPrefab, player.transform.position, Quaternion.identity, Mod.currentStart.propsContainer);//Fix Item Giving for Non Host, Oops
                    gameObject.GetComponent<GrabbableObject>().fallTime = 0f;
                    gameObject.GetComponent<NetworkObject>().Spawn(false);

                    EffectDelegates.msgid++;
                    HUDManager.Instance.AddTextToChatOnServer($"<size=0>/cc_give_{give}_{id}_{gameObject.GetComponent<NetworkObject>().NetworkObjectId}_{EffectDelegates.msgid}</size>");
                ...
                case "mimic":
                {
                    ...
                    EffectDelegates.setProperty(enemy, "enemyEnabled", true);
                    break;
                }
...

                {
                    ...
                    EffectDelegates.setProperty(playerRef, "currentlyGrabbingObject", grab);
                    EffectDelegates.setProperty(playerRef, "grabInvalidated", false);
                    ...
                    EffectDelegates.callFunc(playerRef, "SetSpecialGrabAnimationBool", new System.Object[] { true, null });
                    ...
                    EffectDelegates.callFunc(playerRef, "GrabObjectServerRpc", new NetworkObjectReference(networkObject));

                    Coroutine goc = (Coroutine)EffectDelegates.getProperty(playerRef, "grabObjectCoroutine");
                    ...
                    EffectDelegates.setProperty(playerRef, "grabObjectCoroutine", ((UnityEngine.MonoBehaviour)playerRef).StartCoroutine("GrabObject"));
                }
                    break;
