    ...
    public class ControlClient
    {
        ...
        public bool isReady()
        {
            try
            {
                ...
                if (!StartOfRound.Instance.currentLevel.spawnEnemiesAndScrap) return false;//stop effects running on any moon designated as "Company". Mainly used for Oxyde, and Galetry Modded Moons, but also blocks company spawns.
