...
namespace CrowdControl.Games.Packs.LethalCompany
{
    public class LethalCompany : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                new("Give Apparatus", "give_apparatus") { Category = "Items"},
                new("Give Mapper", "give_mapper") { Category = "Items"},
                ...
                new("Give TZP Inhalant", "give_inhaler") { Category = "Items"},
                new("Give Walkie Talkie", "give_walkie") { Category = "Items"},
                new("Give Zap Gun", "give_zapgun") { Category = "Items"},
                new("Give Magic 7 Ball", "give_magic7ball") { Category = "Items"},
                new("Give Airhorn", "give_airhorn") { Category = "Items"},
                new("Give Bottles", "give_bottles") { Category = "Items"},
                ...
                new("Give Present", "give_present") { Category = "Items"},
                ...
                new("Give Crewmate Apparatus", "cgive_apparatus") { Category = "Items"},
                new("Give Crewmate Mapper", "cgive_mapper") { Category = "Items"},
                ...
                new("Give Crewmate TZP Inhalant", "cgive_inhaler") { Category = "Items"},
                new("Give Crewmate Walkie Talkie", "cgive_walkie") { Category = "Items"},
                new("Give Crewmate Zap Gun", "cgive_zapgun") { Category = "Items"},
                new("Give Crewmate Magic 7 Ball", "cgive_magic7ball") { Category = "Items"},
                new("Give Crewmate Airhorn", "cgive_airhorn") { Category = "Items"},
                new("Give Crewmate Bottles", "cgive_bottles") { Category = "Items"},
                ...
                new("Give Crewmate Present", "cgive_present") { Category = "Items"},
                new("Give Crewmate Tragedy Mask", "cgive_tragedy") { Category = "Items"},
                new("Give Crewmate Comedy Mask", "cgive_comedy") { Category = "Items"},
