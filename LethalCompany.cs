...
namespace CrowdControl.Games.Packs.LethalCompany
{
    public class LethalCompany : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                new("Give Walkie-Talkie", "give_14") { Category = "Items"},
                new("Give Flashlight", "give_3") { Category = "Items"},
                new("Give Shovel", "give_10") { Category = "Items"},
                new("Give Lockpicker", "give_6") { Category = "Items"},
                new("Give Pro Flashlight", "give_9") { Category = "Items"},
                new("Give Stun Grenade", "give_11") { Category = "Items"},
                new("Give Boom Box", "give_1") { Category = "Items"},
                new("Give Inhaler", "give_13") { Category = "Items"},
                new("Give Stun Gun", "give_15") { Category = "Items"},
                new("Give Jet Pack", "give_4") { Category = "Items"},
                new("Give Extension Ladder", "give_12") { Category = "Items"},
                new("Give Radar Booster", "give_57") { Category = "Items"},
                new("Give Tragedy Mask", "give_65") { Category = "Items"},
                new("Give Comedy Mask", "give_66") { Category = "Items"},
                new("Give Spray Paint", "give_61"){ Category = "Items"},
                new("Give Weed Killer", "give_70"){ Category = "Items"},
                new("Give Key", "give_5"){ Category = "Items"},
                new("Give Shotgun", "give_59"){ Category = "Items"},
                new("Give Shells", "give_60"){ Category = "Items"},

                new("Give Crewmate Walkie-Talkie", "cgive_14") { Category = "Items"},
                new("Give Crewmate Flashlight", "cgive_3") { Category = "Items"},
                new("Give Crewmate Shovel", "cgive_10") { Category = "Items"},
                new("Give Crewmate Lockpicker", "cgive_6") { Category = "Items"},
                new("Give Crewmate Pro Flashlight", "cgive_9") { Category = "Items"},
                new("Give Crewmate Stun Grenade", "cgive_11") { Category = "Items"},
                new("Give Crewmate Boom Box", "cgive_1") { Category = "Items"},
                new("Give Crewmate Inhaler", "cgive_13") { Category = "Items"},
                new("Give Crewmate Stun Gun", "cgive_15") { Category = "Items"},
                new("Give Crewmate Jet Pack", "cgive_4") { Category = "Items"},
                new("Give Crewmate Extension Ladder", "cgive_12") { Category = "Items"},
                new("Give Crewmate Radar Booster", "cgive_57") { Category = "Items"},
                new("Give Crewmate Tragedy Mask", "cgive_65") { Category = "Items"},
                new("Give Crewmate Comedy Mask", "cgive_66") { Category = "Items"},
                new("Give Crewmate Spray Paint", "cgive_61"){Category= "Items"},
                new("Give Crewmate Weed Killer", "cgive_70"){Category= "Items"},
                new("Give Crewmate Key", "cgive_5"){Category= "Items"},
                new("Give Crewmate Shotgun", "cgive_59"){Category= "Items"},
                new("Give Crewmate Shells", "cgive_60"){Category= "Items"},
