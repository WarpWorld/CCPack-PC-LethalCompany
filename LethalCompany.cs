...
namespace CrowdControl.Games.Packs.LethalCompany
{
    public class LethalCompany : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                new("Give Boom Box", "give_boombox") { Category = "Items"},
                new("Give Inhaler", "give_inhaler") { Category = "Items"},
                new("Give Stun Gun", "give_stungun") { Category = "Items"},
                new("Give Jet Pack", "give_jetpack") { Category = "Items"},
                ...
                new("Give Weed Killer", "give_weedkiller"){ Category = "Items"},
                new("Give Key", "give_key"){ Category = "Items"},
                new("Give Shotgun", "give_shotgun"){ Category = "Items"},
                new("Give Shells", "give_shells"){ Category = "Items"},
