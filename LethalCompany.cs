...
namespace CrowdControl.Games.Packs.LethalCompany
{
    public class LethalCompany : SimpleTCPPack
    {
        ...
        public override EffectList Effects => new List<Effect>
        {
                ...
                new("Spawn Snare Flea", "spawn_pede") { Category = "Spawn Enemies"},
                ...
                new("Spawn Thumper", "spawn_crawl") { Category = "Spawn Enemies"},
                new("Spawn Blob", "spawn_blob") { Category = "Spawn Enemies"},
                new("Spawn Coil-Head", "spawn_spring") { Category = "Spawn Enemies"},
                new("Spawn Spore Lizard", "spawn_puff") { Category = "Spawn Enemies"},
                ...
                new("Spawn Old Bird", "spawn_radmech") { Category = "Spawn Enemies"},//radmech in files, name is Old Bird
                new("Spawn Barber", "spawn_clay") { Category = "Spawn Enemies"},//Tested on Dine, name is Barber, but is Clay Surgeon in files
                new("Spawn Butler", "spawn_butler"){ Category = "Spawn Enemies"},//Tested on Dine

                new("Spawn Snare Flea at Crewmate", "cspawn_pede") { Category = "Spawn Enemies"},//Snare Flea, Centipede in Files
                new("Spawn Nutcracker at Crewmate", "cspawn_cracker") { Category = "Spawn Enemies"},
                new("Spawn Bunker Spider at Crewmate", "cspawn_spider") { Category = "Spawn Enemies"},//Sand Spider in files, Bunker Spider in name
                new("Spawn Hoarding Bug at Crewmate", "cspawn_hoard") { Category = "Spawn Enemies"},
                new("Spawn Bracken at Crewmate", "cspawn_flower") { Category = "Spawn Enemies"},//Flowerman in files, Bracken name. FlowerSnake for Tulip Snake, so a clash here
                new("Spawn Thumper at Crewmate", "cspawn_crawl") { Category = "Spawn Enemies"},//Thumper, Crawler in Files
                new("Spawn Blob at Crewmate", "cspawn_blob") { Category = "Spawn Enemies"},
                new("Spawn Coil-Head at Crewmate", "cspawn_spring") { Category = "Spawn Enemies"},//SpringMan in files
                new("Spawn Spore Lizard at Crewmate", "cspawn_puff") { Category = "Spawn Enemies"},//Spore Lizard, Puffer in Files
                new("Spawn Eyeless Dog at Crewmate", "cspawn_dog") { Category = "Spawn Enemies"},//Mouthdog in files
                ...
                new("Spawn Mimic at Crewmate", "cspawn_mimic") { Category = "Spawn Enemies"},//Mimic, Masked in files
                new("Spawn Landmine at Crewmate", "cspawn_landmine") { Category = "Spawn Enemies"},
                new("Spawn Old Bird at Crewmate", "cspawn_radmech") { Category = "Spawn Enemies" },//Old Bird, In files its a radmech
                new("Spawn Barber at Crewmate", "cspawn_clay") { Category = "Spawn Enemies"},//Tested on Dine, Clay Surgeon In Files, Barber Scannode
